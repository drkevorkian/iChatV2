...
$allowedPaths = ['messages', 'im', 'admin', 'presence', 'sync', 'patch-log', 'patch-status', 'patch-apply', 'db-repair', 'user-management', 'profile', 'auth', 'moderate', 'room-requests', 'reports', 'admin-notifications', 'pinky-brain', 'log-viewer', 'emojis', 'file-storage', 'mail', 'settings', 'chat-media', 'avatars', 'word-filter', 'websocket-admin', 'audit', 'rbac', 'chatbot-admin', 'terminal'];
